...
-- USUÁRIOS (10)
-- ----------------
-- Senhas criptografadas com BCrypt referentes a "senha123" para todos
INSERT INTO usuarios (id, nome, email, username, senha, foto_perfil, data_criacao) VALUES
('b1000000-0000-0000-0000-000000000001', 'Ana Lima',       'ana.lima@email.com',      'analima',      '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000002', 'Carlos Souza',   'carlos.souza@email.com',  'carlossouza',  '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000003', 'Beatriz Nunes',  'bia.nunes@email.com',     'bianunes',     '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000004', 'Diego Martins',  'diego.martins@email.com', 'diegomartins', '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000005', 'Fernanda Costa', 'fer.costa@email.com',     'fercosta',     '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000006', 'Gabriel Rocha',  'gabriel.rocha@email.com', 'gabrielrocha', '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000007', 'Helena Vieira',  'helena.v@email.com',      'helenavieira',  '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000008', 'Igor Pereira',   'igor.p@email.com',        'igorp',        '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000009', 'Juliana Alves',  'juliana.alves@email.com', 'julialves',    '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW()),
('b1000000-0000-0000-0000-000000000010', 'Lucas Ferreira', 'lucas.fer@email.com',     'lucasfer',     '$2a$10$7QJ8J1z3QkZ9f0Y4Xv2M3OQw6R5T8Y1V3U0P2N4L6K8J0H2F4D6B8', NULL, NOW());
...
('c1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000002'), -- Interestelar → Ficção Científica
('c1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000003'), -- Interestelar → Drama
('c1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000003'), -- Parasita → Drama
('c1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000007'), -- Parasita → Crime
('c1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000007'), -- O Poderoso Chefão → Crime
('c1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003'), -- O Poderoso Chefão → Drama
('c1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000002'), -- Matrix → Ficção Científica
('c1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000001'), -- Matrix → Ação
('c1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000003'), -- Coringa → Drama
('c1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000007'), -- Coringa → Crime
('c1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000006'), -- Toy Story → Animação
('c1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000008'), -- Toy Story → Aventura
('c1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000003'), -- Clube da Luta → Drama
('c1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000006'), -- Coco → Animação
('c1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000008'), -- Coco → Aventura
('c1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000003'), -- Oppenheimer → Drama
('c1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000010'), -- Oppenheimer → Documentário
('c1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000001'), -- Vingadores → Ação
('c1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000008'); -- Vingadores → Aventura
...
('d1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000007'), -- Breaking Bad → Crime
('d1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000003'), -- Breaking Bad → Drama
('d1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001'), -- Game of Thrones → Ação
('d1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000008'), -- Game of Thrones → Aventura
('d1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000004'), -- Stranger Things → Terror
('d1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002'), -- Stranger Things → Ficção Científica
('d1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000005'), -- The Office → Comédia
('d1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000002'), -- Dark → Ficção Científica
('d1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000003'), -- Dark → Drama
('d1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003'), -- Chernobyl → Drama
('d1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000010'), -- Chernobyl → Documentário
('d1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000007'), -- La Casa de Papel → Crime
('d1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000001'), -- La Casa de Papel → Ação
('d1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000001'), -- Attack on Titan → Ação
('d1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000006'), -- Attack on Titan → Animação
('d1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000002'), -- Black Mirror → Ficção Científica
('d1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000004'), -- Black Mirror → Terror
('d1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000007'), -- Peaky Blinders → Crime
('d1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000003'); -- Peaky Blinders → Drama
...
('g1000000-0000-0000-0000-000000000001', 'Meus Favoritos',       false, NOW(), 'b1000000-0000-0000-0000-000000000001'),
('g1000000-0000-0000-0000-000000000002', 'Assistir Depois',      false, NOW(), 'b1000000-0000-0000-0000-000000000002'),
('g1000000-0000-0000-0000-000000000003', 'Top Ficção Científica', true, NOW(), 'b1000000-0000-0000-0000-000000000003'),
('g1000000-0000-0000-0000-000000000004', 'Clássicos do Cinema',  false, NOW(), 'b1000000-0000-0000-0000-000000000004'),
('g1000000-0000-0000-0000-000000000005', 'Séries para Maratonar', true, NOW(), 'b1000000-0000-0000-0000-000000000005'),
('g1000000-0000-0000-0000-000000000006', 'Animações Favoritas',  false, NOW(), 'b1000000-0000-0000-0000-000000000006'),
('g1000000-0000-0000-0000-000000000007', 'Crimes e Suspense',    false, NOW(), 'b1000000-0000-0000-0000-000000000007'),
('g1000000-0000-0000-0000-000000000008', 'Para Ver com a Família', false, NOW(), 'b1000000-0000-0000-0000-000000000008'),
('g1000000-0000-0000-0000-000000000009', 'Indicados ao Oscar',   true,  NOW(), 'b1000000-0000-0000-0000-000000000009'),
('g1000000-0000-0000-0000-000000000010', 'Lista Secreta',        true,  NOW(), 'b1000000-0000-0000-0000-000000000010');

-- Filmes nas listas
INSERT INTO lista_filme (lista_id, filme_id) VALUES
('g1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001'), -- Ana → Interestelar
('g1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000009'), -- Ana → Oppenheimer
('g1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000004'), -- Carlos → Matrix
('g1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000004'), -- Beatriz → Matrix
('g1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000003'), -- Diego → O Poderoso Chefão
('g1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000007'), -- Diego → Clube da Luta
('g1000000-0000-0000-0000-000000000006', 'c1000000-0000-0000-0000-000000000006'), -- Gabriel → Toy Story
('g1000000-0000-0000-0000-000000000006', 'c1000000-0000-0000-0000-000000000008'), -- Gabriel → Coco
('g1000000-0000-0000-0000-000000000007', 'c1000000-0000-0000-0000-000000000002'), -- Helena → Parasita
('g1000000-0000-0000-0000-000000000009', 'c1000000-0000-0000-0000-000000000002'); -- Juliana → Parasita

-- Séries nas listas
INSERT INTO lista_serie (lista_id, serie_id) VALUES
('g1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001'), -- Ana → Breaking Bad
('g1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000002'), -- Carlos → Game of Thrones
('g1000000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000009'), -- Beatriz → Black Mirror
('g1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000001'), -- Fernanda → Breaking Bad
('g1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000005'), -- Fernanda → Dark
('g1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000007'), -- Helena → La Casa de Papel
('g1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000010'), -- Helena → Peaky Blinders
('g1000000-0000-0000-0000-000000000008', 'd1000000-0000-0000-0000-000000000003'), -- Igor → Stranger Things
('g1000000-0000-0000-0000-000000000009', 'd1000000-0000-0000-0000-000000000006'), -- Juliana → Chernobyl
('g1000000-0000-0000-0000-000000000010', 'd1000000-0000-0000-0000-000000000008'); -- Lucas → Attack on Titan
